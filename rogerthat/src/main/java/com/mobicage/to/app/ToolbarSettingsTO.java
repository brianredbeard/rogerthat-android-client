...
public class ToolbarSettingsTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.app.NavigationItemTO[] items;

    public ToolbarSettingsTO() {
    }

    @SuppressWarnings("unchecked")
    public ToolbarSettingsTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("items")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.app.ToolbarSettingsTO object is missing field 'items'");
        }
    }
