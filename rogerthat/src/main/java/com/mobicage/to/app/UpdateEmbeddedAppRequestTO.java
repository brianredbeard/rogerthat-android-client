...
public class UpdateEmbeddedAppRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdateEmbeddedAppRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("description")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.app.UpdateEmbeddedAppRequestTO object is missing field 'description'");
        }
        ...
        if (json.containsKey("title")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.app.UpdateEmbeddedAppRequestTO object is missing field 'title'");
        }
