...
public class UpdateAppAssetRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdateAppAssetRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("kind")) {
            Object val = json.get("kind");
            this.kind = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.app.UpdateAppAssetRequestTO object is missing field 'kind'");
        }
