...
public class UpdateEmbeddedAppsRequestTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.app.EmbeddedAppTO[] embedded_apps;

    public UpdateEmbeddedAppsRequestTO() {
    }

    @SuppressWarnings("unchecked")
    public UpdateEmbeddedAppsRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("embedded_apps")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.app.UpdateEmbeddedAppsRequestTO object is missing field 'embedded_apps'");
        }
    }
