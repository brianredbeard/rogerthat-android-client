...
public class GetJSEmbeddingResponseTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.js_embedding.JSEmbeddingItemTO[] items;

    public GetJSEmbeddingResponseTO() {
    }

    @SuppressWarnings("unchecked")
    public GetJSEmbeddingResponseTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("items")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.js_embedding.GetJSEmbeddingResponseTO object is missing field 'items'");
        }
    }
