...
public class UpdatePaymentProviderRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdatePaymentProviderRequestTO() {
    }

    public UpdatePaymentProviderRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("asset_types")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'asset_types'");
        }
        if (json.containsKey("background_color")) {
            Object val = json.get("background_color");
            this.background_color = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'background_color'");
        }
        if (json.containsKey("black_white_logo")) {
            Object val = json.get("black_white_logo");
            this.black_white_logo = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'black_white_logo'");
        }
        if (json.containsKey("button_color")) {
            Object val = json.get("button_color");
            this.button_color = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'button_color'");
        }
        if (json.containsKey("currencies")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'currencies'");
        }
        ...
        if (json.containsKey("enabled")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'enabled'");
        }
        if (json.containsKey("id")) {
            Object val = json.get("id");
            this.id = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'id'");
        }
        if (json.containsKey("logo_url")) {
            Object val = json.get("logo_url");
            this.logo_url = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'logo_url'");
        }
        if (json.containsKey("name")) {
            Object val = json.get("name");
            this.name = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'name'");
        }
        if (json.containsKey("oauth_authorize_url")) {
            Object val = json.get("oauth_authorize_url");
            this.oauth_authorize_url = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'oauth_authorize_url'");
        }
        if (json.containsKey("text_color")) {
            Object val = json.get("text_color");
            this.text_color = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'text_color'");
        }
        if (json.containsKey("version")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentProviderRequestTO object is missing field 'version'");
        }
    }
