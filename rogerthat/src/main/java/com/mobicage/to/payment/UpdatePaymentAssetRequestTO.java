...
public class UpdatePaymentAssetRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdatePaymentAssetRequestTO() {
    }
    ...
    public UpdatePaymentAssetRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        ...
        if (json.containsKey("currency")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'currency'");
        }
        if (json.containsKey("enabled")) {
            Object val = json.get("enabled");
            this.enabled = ((Boolean) val).booleanValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'enabled'");
        }
        if (json.containsKey("has_balance")) {
            Object val = json.get("has_balance");
            this.has_balance = ((Boolean) val).booleanValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'has_balance'");
        }
        if (json.containsKey("has_transactions")) {
            Object val = json.get("has_transactions");
            this.has_transactions = ((Boolean) val).booleanValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'has_transactions'");
        }
        if (json.containsKey("id")) {
            Object val = json.get("id");
            this.id = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'id'");
        }
        if (json.containsKey("name")) {
            Object val = json.get("name");
            this.name = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'name'");
        }
        if (json.containsKey("provider_id")) {
            Object val = json.get("provider_id");
            this.provider_id = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'provider_id'");
        }
        if (json.containsKey("type")) {
            Object val = json.get("type");
            this.type = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'type'");
        }
        if (json.containsKey("verified")) {
            Object val = json.get("verified");
            this.verified = ((Boolean) val).booleanValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.UpdatePaymentAssetRequestTO object is missing field 'verified'");
        }
    }
