...
public class ConfirmPaymentResponseTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.payment.ErrorPaymentTO error;
    public com.mobicage.to.payment.PendingPaymentTO result;
    public boolean success;

    public ConfirmPaymentResponseTO() {
    }

    @SuppressWarnings("unchecked")
    public ConfirmPaymentResponseTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("error")) {
            Object val = json.get("error");
            this.error = val == null ? null : new com.mobicage.to.payment.ErrorPaymentTO((Map<String, Object>) val);
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.ConfirmPaymentResponseTO object is missing field 'error'");
        }
        if (json.containsKey("result")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.payment.ConfirmPaymentResponseTO object is missing field 'result'");
        }
        if (json.containsKey("success")) {
            Object val = json.get("success");
            this.success = ((Boolean) val).booleanValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.payment.ConfirmPaymentResponseTO object is missing field 'success'");
        }
    }
