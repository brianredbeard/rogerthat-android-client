...
public class RangeSliderFormTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.messaging.forms.RangeSliderTO widget;
    ...
    public RangeSliderFormTO() {
    }

    @SuppressWarnings("unchecked")
    public RangeSliderFormTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("widget")) {
            Object val = json.get("widget");
            this.widget = val == null ? null : new com.mobicage.to.messaging.forms.RangeSliderTO((Map<String, Object>) val);
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'widget'");
        }
        ...
        if (json.containsKey("negative_button")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'negative_button'");
        }
        ...
        if (json.containsKey("negative_confirmation")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'negative_confirmation'");
        }
        if (json.containsKey("positive_button")) {
            Object val = json.get("positive_button");
            this.positive_button = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'positive_button'");
        }
        ...
        if (json.containsKey("positive_confirmation")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'positive_confirmation'");
        }
        if (json.containsKey("type")) {
            Object val = json.get("type");
            this.type = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RangeSliderFormTO object is missing field 'type'");
        }
    }
