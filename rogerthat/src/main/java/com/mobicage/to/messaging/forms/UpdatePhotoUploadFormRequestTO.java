...
public class UpdatePhotoUploadFormRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdatePhotoUploadFormRequestTO() {
    }

    @SuppressWarnings("unchecked")
    public UpdatePhotoUploadFormRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("result")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'result'");
        }
        if (json.containsKey("acked_timestamp")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'acked_timestamp'");
        }
        if (json.containsKey("button_id")) {
            Object val = json.get("button_id");
            this.button_id = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'button_id'");
        }
        if (json.containsKey("message_key")) {
            Object val = json.get("message_key");
            this.message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'message_key'");
        }
        if (json.containsKey("parent_message_key")) {
            Object val = json.get("parent_message_key");
            this.parent_message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'parent_message_key'");
        }
        if (json.containsKey("received_timestamp")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'received_timestamp'");
        }
        if (json.containsKey("status")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdatePhotoUploadFormRequestTO object is missing field 'status'");
        }
    }
