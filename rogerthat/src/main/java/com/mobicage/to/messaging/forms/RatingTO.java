...
public class RatingTO implements com.mobicage.rpc.IJSONable {
    ...
    public RatingTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("topics")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.RatingTO object is missing field 'topics'");
        }
    }
