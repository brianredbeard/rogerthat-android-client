...
public class AdvancedOrderWidgetResultTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.models.properties.forms.AdvancedOrderCategory[] categories;
    public String currency;

    public AdvancedOrderWidgetResultTO() {
    }

    @SuppressWarnings("unchecked")
    public AdvancedOrderWidgetResultTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("categories")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.AdvancedOrderWidgetResultTO object is missing field 'categories'");
        }
        if (json.containsKey("currency")) {
            Object val = json.get("currency");
            this.currency = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.AdvancedOrderWidgetResultTO object is missing field 'currency'");
        }
    }
