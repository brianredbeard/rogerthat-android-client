...
public class UpdateMessageEmbeddedAppRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdateMessageEmbeddedAppRequestTO() {
    }

    @SuppressWarnings("unchecked")
    public UpdateMessageEmbeddedAppRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("embedded_app")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.UpdateMessageEmbeddedAppRequestTO object is missing field 'embedded_app'");
        }
        if (json.containsKey("message_key")) {
            Object val = json.get("message_key");
            this.message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.UpdateMessageEmbeddedAppRequestTO object is missing field 'message_key'");
        }
        if (json.containsKey("parent_message_key")) {
            Object val = json.get("parent_message_key");
            this.parent_message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.UpdateMessageEmbeddedAppRequestTO object is missing field 'parent_message_key'");
        }
    }
