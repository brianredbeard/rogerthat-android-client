...
public class PayFormTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.messaging.forms.PayTO widget;
    ...
    public PayFormTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("widget")) {
            Object val = json.get("widget");
            this.widget = val == null ? null : new com.mobicage.to.messaging.forms.PayTO((Map<String, Object>) val);
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'widget'");
        }
        ...
        if (json.containsKey("negative_button")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'negative_button'");
        }
        if (json.containsKey("negative_button_ui_flags")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'negative_button_ui_flags'");
        }
        if (json.containsKey("negative_confirmation")) {
            Object val = json.get("negative_confirmation");
            this.negative_confirmation = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'negative_confirmation'");
        }
        if (json.containsKey("positive_button")) {
            Object val = json.get("positive_button");
            this.positive_button = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'positive_button'");
        }
        if (json.containsKey("positive_button_ui_flags")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'positive_button_ui_flags'");
        }
        if (json.containsKey("positive_confirmation")) {
            Object val = json.get("positive_confirmation");
            this.positive_confirmation = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'positive_confirmation'");
        }
        if (json.containsKey("type")) {
            Object val = json.get("type");
            this.type = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.PayFormTO object is missing field 'type'");
        }
    }
