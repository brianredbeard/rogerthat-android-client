...
public class SingleSliderFormMessageTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.messaging.AttachmentTO[] attachments;
    public com.mobicage.to.messaging.forms.SingleSliderFormTO form;
    ...
    public SingleSliderFormMessageTO() {
    }

    @SuppressWarnings("unchecked")
    public SingleSliderFormMessageTO(Map<String, Object> json) throws IncompleteMessageException {
        ...
        if (json.containsKey("form")) {
            ...
            this.form = val == null ? null : new com.mobicage.to.messaging.forms.SingleSliderFormTO((Map<String, Object>) val);
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'form'");
        }
        if (json.containsKey("member")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'member'");
        }
        ...
        if (json.containsKey("branding")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'branding'");
        }
        ...
        if (json.containsKey("context")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'context'");
        }
        ...
        if (json.containsKey("key")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'key'");
        }
        if (json.containsKey("message")) {
            Object val = json.get("message");
            this.message = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'message'");
        }
        ...
        if (json.containsKey("parent_key")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'parent_key'");
        }
        ...
        if (json.containsKey("sender")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SingleSliderFormMessageTO object is missing field 'sender'");
        }
