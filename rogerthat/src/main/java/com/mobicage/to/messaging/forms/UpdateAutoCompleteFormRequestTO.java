...
public class UpdateAutoCompleteFormRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public UpdateAutoCompleteFormRequestTO() {
    }

    @SuppressWarnings("unchecked")
    public UpdateAutoCompleteFormRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("result")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'result'");
        }
        if (json.containsKey("acked_timestamp")) {
            Object val = json.get("acked_timestamp");
            this.acked_timestamp = ((Long) val).longValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'acked_timestamp'");
        }
        if (json.containsKey("button_id")) {
            Object val = json.get("button_id");
            this.button_id = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'button_id'");
        }
        if (json.containsKey("message_key")) {
            Object val = json.get("message_key");
            this.message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'message_key'");
        }
        if (json.containsKey("parent_message_key")) {
            Object val = json.get("parent_message_key");
            this.parent_message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'parent_message_key'");
        }
        if (json.containsKey("received_timestamp")) {
            Object val = json.get("received_timestamp");
            this.received_timestamp = ((Long) val).longValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'received_timestamp'");
        }
        if (json.containsKey("status")) {
            Object val = json.get("status");
            this.status = ((Long) val).longValue();
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.UpdateAutoCompleteFormRequestTO object is missing field 'status'");
        }
    }
