...
public class TextBlockTO implements com.mobicage.rpc.IJSONable {
    ...
    public TextBlockTO(Map<String, Object> json) throws IncompleteMessageException {
        ...
        if (json.containsKey("max_chars")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.TextBlockTO object is missing field 'max_chars'");
        }
        if (json.containsKey("place_holder")) {
            Object val = json.get("place_holder");
            this.place_holder = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.TextBlockTO object is missing field 'place_holder'");
        }
        if (json.containsKey("value")) {
            Object val = json.get("value");
            this.value = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.TextBlockTO object is missing field 'value'");
        }
    }
