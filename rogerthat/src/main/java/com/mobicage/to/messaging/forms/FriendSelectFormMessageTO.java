...
public class FriendSelectFormMessageTO implements com.mobicage.rpc.IJSONable {

    public com.mobicage.to.messaging.AttachmentTO[] attachments;
    public com.mobicage.to.messaging.forms.FriendSelectFormTO form;
    ...
    public FriendSelectFormMessageTO() {
    }

    @SuppressWarnings("unchecked")
    public FriendSelectFormMessageTO(Map<String, Object> json) throws IncompleteMessageException {
        ...
        if (json.containsKey("form")) {
            ...
            this.form = val == null ? null : new com.mobicage.to.messaging.forms.FriendSelectFormTO((Map<String, Object>) val);
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'form'");
        }
        if (json.containsKey("member")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'member'");
        }
        if (json.containsKey("alert_flags")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'alert_flags'");
        }
        if (json.containsKey("branding")) {
            Object val = json.get("branding");
            this.branding = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'branding'");
        }
        ...
        if (json.containsKey("context")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'context'");
        }
        ...
        if (json.containsKey("flags")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'flags'");
        }
        if (json.containsKey("key")) {
            Object val = json.get("key");
            this.key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'key'");
        }
        if (json.containsKey("message")) {
            Object val = json.get("message");
            this.message = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'message'");
        }
        if (json.containsKey("message_type")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'message_type'");
        }
        if (json.containsKey("parent_key")) {
            Object val = json.get("parent_key");
            this.parent_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'parent_key'");
        }
        ...
        if (json.containsKey("sender")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'sender'");
        }
        if (json.containsKey("threadTimestamp")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'threadTimestamp'");
        }
        ...
        if (json.containsKey("thread_size")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'thread_size'");
        }
        ...
        if (json.containsKey("timestamp")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.FriendSelectFormMessageTO object is missing field 'timestamp'");
        }
    }
