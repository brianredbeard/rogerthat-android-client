...
public class SubmitPayFormRequestTO implements com.mobicage.rpc.IJSONable {
    ...
    public SubmitPayFormRequestTO(Map<String, Object> json) throws IncompleteMessageException {
        ...
        if (json.containsKey("button_id")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SubmitPayFormRequestTO object is missing field 'button_id'");
        }
        if (json.containsKey("message_key")) {
            Object val = json.get("message_key");
            this.message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SubmitPayFormRequestTO object is missing field 'message_key'");
        }
        if (json.containsKey("parent_message_key")) {
            Object val = json.get("parent_message_key");
            this.parent_message_key = (String) val;
        } else {
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SubmitPayFormRequestTO object is missing field 'parent_message_key'");
        }
        if (json.containsKey("timestamp")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.messaging.forms.SubmitPayFormRequestTO object is missing field 'timestamp'");
        }
    }
