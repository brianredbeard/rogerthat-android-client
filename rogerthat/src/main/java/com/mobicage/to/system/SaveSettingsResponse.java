...
public class SaveSettingsResponse implements com.mobicage.rpc.IJSONable {
    ...
    public SaveSettingsResponse(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("settings")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.system.SaveSettingsResponse object is missing field 'settings'");
        }
    }
