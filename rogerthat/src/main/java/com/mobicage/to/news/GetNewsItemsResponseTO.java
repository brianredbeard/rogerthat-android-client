...
public class GetNewsItemsResponseTO implements com.mobicage.rpc.IJSONable {
    ...
    public GetNewsItemsResponseTO(Map<String, Object> json) throws IncompleteMessageException {
        if (json.containsKey("items")) {
            ...
            throw new IncompleteMessageException("com.mobicage.to.news.GetNewsItemsResponseTO object is missing field 'items'");
        }
    }
