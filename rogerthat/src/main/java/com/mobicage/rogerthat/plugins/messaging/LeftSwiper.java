...
public class LeftSwiper implements Slider.Swiper {
    ...
    public LeftSwiper(Context context, MessagingPlugin messagingPlugin, String parentMessageKey, String memberFilter) {
        mContext = context;
    ...
    public Intent onSwipe() {
        return mMessagingPlugin.getNextMessageThreadActivityIntent(mContext, mParentMessageKey, mMemberFilter);
    }
