...
public class ZipUtils {
     ...
     * 
     * Copyright 2006 Sun Microsystems, Inc. All rights reserved. SUN PROPRIETARY/CONFIDENTIAL. Use is subject to
     * license terms.
     */
    ...
    public static class DeflaterInputStream extends FilterInputStream {
        ...
        /**
         * Reads a single byte of compressed data from the input stream. This method will block until some input can be
         * read and compressed.
         * 
        ...
        /**
         * Skips over and discards data from the input stream. This method may block until the specified number of bytes
         * are read and skipped. <em>Note:</em> While {@code n} is given as a {@code long}, the maximum number of bytes
