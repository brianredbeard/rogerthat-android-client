...
public class NavigationConstants {
    ...
    public static ServiceBoundActivity.NavigationItem[] getNavigationFooterItems() {
        return new ServiceBoundActivity.NavigationItem[]{
            new ServiceBoundActivity.NavigationItem(FontAwesome.Icon.faw_newspaper_o, null, "news", R.string.tab_messaging),
            new ServiceBoundActivity.NavigationItem(FontAwesome.Icon.faw_shopping_cart, "action", "__sln__.order", R.string.order),
            new ServiceBoundActivity.NavigationItem(FontAwesome.Icon.faw_calendar, "click", "agenda", R.string.agenda),
            new ServiceBoundActivity.NavigationItem(FontAwesome.Icon.faw_credit_card, null, "qrcode", R.string.app_name),
        };
    }
}
