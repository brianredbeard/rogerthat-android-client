...
public class ServicesStartAction extends SingleCall {

    public ServicesStartAction(String function, String callBody) {
    ...
    public boolean isEqualToCallWithBody(String callBody) {
        ...
        String thisAction = (String) request.get("action");
        String otherAction = (String) otherRequest.get("action");
