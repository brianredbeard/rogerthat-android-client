...
/**
 * A variant of MergeCursor that sorts the cursors being merged. If decent performance is ever obtained, it can be put
 * back under android.database.
 */
public class SortCursor extends AbstractCursor {
    ...
    public boolean onMove(int oldPosition, int newPosition) {
        ...
        /*
         * Find the right cursor Because the client of this cursor (the listadapter/view) tends to jump around in the
         * cursor somewhat, a simple cache strategy is used to avoid having to search all cursors from the start. TODO:
         * investigate strategies for optimizing random access and reverse-order access.
         */
