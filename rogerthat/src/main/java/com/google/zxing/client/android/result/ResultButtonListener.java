...
/**
 * Handles the result of barcode decoding in the context of the Android platform, by dispatching the proper intents to
 * open other activities like GMail, Maps, etc.
 * 
