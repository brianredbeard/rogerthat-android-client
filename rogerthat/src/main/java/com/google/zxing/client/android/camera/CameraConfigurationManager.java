...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera, final boolean safeMode) {
        Camera.Parameters parameters = camera.getParameters();
    ...
    private void doSetTorch(Camera.Parameters parameters, final boolean newSetting, final boolean safeMode) {
        String flashMode;
        if (newSetting) {
