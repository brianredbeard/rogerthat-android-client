 ...
 */
public final class QRCodeScannerViewfinderView extends View {
    ...
    private QRCodeScannerCameraManager cameraManager;
    ...
    public QRCodeScannerViewfinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setCameraManager(QRCodeScannerCameraManager cameraManager) {
