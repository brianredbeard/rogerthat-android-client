...
final class QRCodeScannerDecodeHandler extends Handler {
    ...
    QRCodeScannerDecodeHandler(QRCodeScanner qrCodeScanner, Map<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = mQRCodeScanner.cameraManager.buildLuminanceSource(data, width, height);
        if (source != null) {
        ...
        Handler handler = mQRCodeScanner.handler;
        if (rawResult != null) {
            // Don't log the barcode contents for security.
            long end = System.currentTimeMillis();
            L.i("Found barcode in " + (end - start) + " ms");
            if (handler != null) {
