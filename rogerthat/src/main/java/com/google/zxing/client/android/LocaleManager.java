...
public final class LocaleManager {
    ...
    /**
     * Locales (well, countries) where Google web search is available. These should be kept in sync with our
     * translations.
     */
    ...
    /**
     * @return country-specific TLD suffix appropriate for the current default locale (e.g. "co.uk" for the United
     *         Kingdom)
     */
