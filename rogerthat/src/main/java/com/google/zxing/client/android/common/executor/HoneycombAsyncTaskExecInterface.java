...
/**
 * On Honeycomb and later, {@link AsyncTask} returns to serial execution by default which is undesirable. This calls
 * Honeycomb-only APIs to request parallel execution.
 */
@TargetApi(11)
